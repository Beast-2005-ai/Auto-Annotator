...
export const RecipeBuilder: React.FC<RecipeBuilderProps> = ({ onBack }) => {
  ...
  const handlePlayAgain = () => {
    const confirmReset = window.confirm("WARNING: Have you downloaded the .PT file? This is a one-time session. If you proceed, you will lose access to this download link on the screen.");
    if (confirmReset) {
        ...
        <div className="w-full max-w-2xl bg-black/80 border-4 border-gray-400 p-8 shadow-[8px_8px_0_rgba(0,0,0,0.7)] backdrop-blur-sm min-h-[400px] flex flex-col items-center justify-center relative">
          ...
          {step === 1 && (
            <div className="text-center w-full flex flex-col items-center">
              ...
              {selectedFile ? (
                <p className="text-green-400 text-xs mt-4 drop-shadow-[0_0_5px_rgba(0,255,0,0.5)]">LOCKED: {selectedFile.name}</p>
              ) : (
            ...
            <div className="text-center w-full flex flex-col items-center">
              ...
              <div className="flex flex-col gap-4 w-full max-w-xs">
                ...
                {proofImages.length > 0 && (
                  <button 
                    className="retro-btn !bg-blue-600 !border-white text-xs" 
        ...
        <div className="fixed inset-0 z-50 bg-black/95 flex flex-col items-center justify-center p-8 backdrop-blur-lg">
          <div className="w-full max-w-5xl flex justify-between items-center mb-6">
            ...
            <button 
              ...
              className="text-white text-2xl hover:text-red-500 font-sans"
            >
              ✖
            </button>
          </div>
